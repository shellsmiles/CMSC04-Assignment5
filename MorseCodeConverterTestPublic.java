...
/**
*This test includes the two student tests.
*/
public class MorseCodeConverterTestPublic {
	...
	@Test  //student
	public void testConvertMorseStringToEnglishString_Student() {	
		String converter2 = MorseCodeConverter.convertToEnglish("--. --- --- -.. / -. .. --. .... - ");
		assertEquals("good night",converter2);
	}

	@Test // student
	public void testConvertMorseFileToEnglishString_Student() {	
		File file = new File("Numbers.txt"); 
		try {
			assertEquals("one two three music", MorseCodeConverter.convertToEnglish(file));
		} catch (FileNotFoundException e) {
			assertTrue("An unwanted exception was caught", false);
		}
	}
